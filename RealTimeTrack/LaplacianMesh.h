...
public:
    ...
    const arma::mat& GetBigReglMat2D() const {
        return bigReglMat2D;
    }
    ...
    const arma::mat& GetBigParamMat2D() const {
        return bigParamMat2D;
    }
    ...
    const arma::mat& GetBigAP2D() const {
        return this->bigAP2D;
    }

    // Return the number of control points
	int GetNCtrlPoints() const {
		return (int)this->ctrPointIds.n_elem;
	}
