...
public:
    ...
    static void DrawKeyPoints( cv::Mat inputImg, const TriangleMesh& triangleMesh, const arma::urowvec& ids, const Camera& camera,
                              const cv::Scalar& color );
    
    static void DrawCenter( cv::Mat inputImg,
    ...
    static void DrawRectangle3D(const std::vector<cv::Point2f> points);
};
